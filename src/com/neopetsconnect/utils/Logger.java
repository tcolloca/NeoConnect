...
public class Logger implements Categories {
  ...
  static {
    ...
    out = new CategoryLogger(System.out).setCategoryFormat("[%s] ").setDefaultCategory(MAIN);

    out.addCategoryChildren(DAILIES,
        Arrays.asList(new String[] {QUESTS, KITCHEN_QUEST, FOOD_CLUB, TDMGPOP, HEALING_SPRINGS,
