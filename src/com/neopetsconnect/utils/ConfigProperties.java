...
public interface ConfigProperties extends Categories {
	...
	int FAERIE_QUEST_MAX_COST = ConfigPropertiesReader.props.getInt(FAERIE_QUEST, "max_cost", Integer.MAX_VALUE);
	List<String> FAERIES_TO_ACCEPT = ConfigPropertiesReader.props.getList(FAERIE_QUEST, "accept", ",", null);
	List<String> FAERIES_TO_REJECT = ConfigPropertiesReader.props.getList(FAERIE_QUEST, "reject", ",", Arrays.asList());
