...
public interface ConfigProperties extends Categories {
  ...
  int AFTER_BOUGHT_SLEEP_TIME =
      ConfigPropertiesReader.props.getInt(RESTOCK, "after_bought_sleep_time");
  ...
  int MIN_SOLD_OUT_WAIT_TIME =
      ConfigPropertiesReader.props.getInt(RESTOCK, "min_sold_out_wait_time");
  int MAX_SOLD_OUT_WAIT_TIME =
      ConfigPropertiesReader.props.getInt(RESTOCK, "max_sold_out_wait_time");
  ...
  int KITCHEN_QUEST_DAILY_MAX_SPEND =
      ConfigPropertiesReader.props.getInt(KITCHEN_QUEST, "daily_max_spend");
  ...
  // TRAINING_SCHOOL
  boolean TRAINING_SCHOOL_ENABLED =
      ConfigPropertiesReader.props.getBoolean(TRAINING_SCHOOL, "enabled");
  String STAT_TYPE = ConfigPropertiesReader.props.getString(TRAINING_SCHOOL, "stat_type", null);

  // TDMGPOP
  boolean TDMGPOP_ENABLED = ConfigPropertiesReader.props.getBoolean(TDMGPOP, "enabled");

  // HEALING_SPRINGS
  boolean HEALING_SPRINGS_ENABLED =
      ConfigPropertiesReader.props.getBoolean(HEALING_SPRINGS, "enabled");
  ...
  // BURIED_TREASURE
  boolean BURIED_TREASURE_ENABLED =
      ConfigPropertiesReader.props.getBoolean(BURIED_TREASURE, "enabled");
  ...
  // FISHING_VORTEX
  boolean FISHING_VORTEX_ENABLED =
      ConfigPropertiesReader.props.getBoolean(FISHING_VORTEX, "enabled");
  ...
  int EDNAS_QUEST_DAILY_MAX_SPEND =
      ConfigPropertiesReader.props.getInt(EDNAS_QUEST, "daily_max_spend");
  ...
  // COLTZANS_SHRINE
  boolean COLTZANS_SHRINE_ENABLED =
      ConfigPropertiesReader.props.getBoolean(COLTZANS_SHRINE, "enabled");

  // FORGOTTEN_SHORE
  boolean FORGOTTEN_SHORE_ENABLED =
      ConfigPropertiesReader.props.getBoolean(FORGOTTEN_SHORE, "enabled");
  ...
  // ORGANIZE_INVENTORY
  boolean ORGANIZE_INVENTORY_ENABLED =
      ConfigPropertiesReader.props.getBoolean(ORGANIZE_INVENTORY, "enabled");
  int STOCK_MIN_PRICE = ConfigPropertiesReader.props.getInt(ORGANIZE_INVENTORY, "min_price");

  // FAERIE QUEST
  boolean FAERIE_QUEST_ENABLED = ConfigPropertiesReader.props.getBoolean(FAERIE_QUEST, "enabled");
  int FAERIE_QUEST_MAX_COST =
      ConfigPropertiesReader.props.getInt(FAERIE_QUEST, "max_cost", Integer.MAX_VALUE);
  List<String> FAERIES_TO_ACCEPT =
      ConfigPropertiesReader.props.getList(FAERIE_QUEST, "accept", ",", null);
  List<String> FAERIES_TO_REJECT =
      ConfigPropertiesReader.props.getList(FAERIE_QUEST, "reject", ",", Arrays.asList());
  String SIDE_USERNAME = ConfigPropertiesReader.props.getString(FAERIE_QUEST, "username");
  String SIDE_PASSWORD = ConfigPropertiesReader.props.getString(FAERIE_QUEST, "password");

  // LOGGING
  boolean LOG_CAPTCHA_IMAGES =
      ConfigPropertiesReader.props.getBoolean(LOGGING, "log_captcha_images");
  ...
  // DEBUG
  boolean DEBUG_ENABLED = ConfigPropertiesReader.props.getBoolean(DEBUG, "enabled");
  double DELAY = ConfigPropertiesReader.props.getDouble(DEBUG, "delay", 0);
}
